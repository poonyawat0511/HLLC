...
import V2Userform from '~/modules/users/components/V2Userform.vue'
import V2UserListDelete from '~/modules/users/components/V2UserListDelete.vue'
...
interface IMajor extends MajorEntity {
  school: SchoolEntity
}
...
const deleteUser = async (userids: string[] | string) => {
  console.log(userids);
  
  try {
    let ids: string[] = []
    if (typeof userids === 'string') {
      ids.push(userids as string)

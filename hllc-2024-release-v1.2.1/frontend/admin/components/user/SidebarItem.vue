...
import { computeSize, computed, useRouter } from '#imports'
...
<template>
  <v-sheet :theme="theme" color="transparent" class="sidebar-item__container">
    <v-sheet :color="color" class="before" />
    <v-sheet
      :class="{ 'sidebar-item': true, active }"
      :height="itemHeight"
    ...
    >
      ...
      <div height="inherit" class="sidebar-item__content">
        <div class="prepend">
          <slot name="icon" :props="{ class: 'mr-2' }">
